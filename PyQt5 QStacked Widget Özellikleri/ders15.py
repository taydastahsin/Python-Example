...
class ders15_main (QMainWindow):
    def __init__(self):
        ...
        self.kitap_listesi_index = 1
        self.kitap_ekle_index = 2
        self.uye_listesi_index = 3
        self.uye_ekle_index = 4
        ...
        self.ui.action_ye_Listesi.triggered.connect(self.go_üye_listesi)
